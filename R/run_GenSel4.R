...
#'           2) -p partition name, default=batch, 3) --mem=30G, 4) --ntasks=3, and 5) --time=8:00:00.
#'
...
#'             email=NULL, runinfo = c(FALSE, "batch", "30G", 1, 8:00:00) )
#'
#' @export
run_GenSel4 <- function(
  ...
  remove=TRUE,
  email=NULL, runinfo = c(FALSE, "batch", "30G", 3, 8:00:00)
){
