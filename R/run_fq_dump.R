...
#' @param slurmsh File name of the output shell command. [chr, "slurm-script/dump.sh"]
...
#'
#' @export
run_fq_dump <- function(inputdf, rmsra=FALSE, gzip=TRUE, email=NULL,
  ...
  set_array_job(shid="slurm-script/run_dump_array.sh",
