...
java -Xmx1g -jar $HOME/bin/picard-tools-2.1.1/picard.jar SortSam \
...
### Mark duplicates
java -Xmx1g -jar $HOME/bin/picard-tools-2.1.1/picard.jar MarkDuplicates \
INPUT=mysample.sorted.bam \
OUTPUT=mysample.sorted.dedup.bam \
METRICS_FILE=mysample_metrics.txt

java -Xmx1g -jar $HOME/bin/picard-tools-2.1.1/picard.jar BuildBamIndex \
...
java -Xmx1g -jar $HOME/bin/GenomeAnalysisTK-3.5/GenomeAnalysisTK.jar \
-T HaplotypeCaller \
